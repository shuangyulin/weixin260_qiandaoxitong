...
public class KechengkaoqinView extends KechengkaoqinEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 考勤状态的值
		*/
		private String kechengkaoqinValue;
	...
	public KechengkaoqinView(KechengkaoqinEntity kechengkaoqinEntity) {
		try {
			BeanUtils.copyProperties(this, kechengkaoqinEntity);
			...
			* 获取： 考勤状态的值
			*/
			public String getKechengkaoqinValue() {
				return kechengkaoqinValue;
			}
			/**
			* 设置： 考勤状态的值
			*/
			public void setKechengkaoqinValue(String kechengkaoqinValue) {
				this.kechengkaoqinValue = kechengkaoqinValue;
			}
