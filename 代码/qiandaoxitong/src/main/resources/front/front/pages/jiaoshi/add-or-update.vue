        ...
        <form class="app-update-pv">
            ...
            <view
                ...
                <view
                    ...
                    <input   disabled
                             :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#f06f4f","borderRadius":"0px","color":"#f06f4f","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                             :disabled="ro.yonghuDelete" type="number" v-model="ruleForm.yonghuDelete" placeholder="假删"></input>
                </view>
    ...
    export default {
        ...
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.yonghuDelete) && (!this.$validate.isIntNumer(this.ruleForm.yonghuDelete)) && this.ruleForm.yonghuDelete >0) {
                    this.$utils.msg(`假删不能为空，不能小于0 格式为数字`);
                    return
                }
                if (this.ruleForm.id) {
